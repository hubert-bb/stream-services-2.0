...
@AllArgsConstructor
@Slf4j
public class TransactionsItemWriter implements ItemWriter<SchemasTransactionPost> {
    ...
    @Override
    public void write(@NonNull List<? extends SchemasTransactionPost> items) throws Exception {

        List<SchemasTransactionPost> list = (List<SchemasTransactionPost>) items;
